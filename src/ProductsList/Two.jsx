...
export const product = {
  ...
  price: 1299,
  description:
    "The Nike Air Jordan 1 in the classic “Bred” colorway is one of the most iconic sneakers ever released, blending performance heritage with timeless streetwear appealy",
  sizes: ["6", "7", "8", "9", "10", "11"],
  images: [
    "./02a.png", 
    "./List02.jpeg", 
