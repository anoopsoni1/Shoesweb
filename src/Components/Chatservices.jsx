...
const dispatch = useDispatch()
  ...
  const handleAsk = useCallback(async () => {
    ...
    try {
      const res = await axios.post("https://shoesbackend-2-xrez.onrender.com/api/v1/user/chat", {
        name,
        question,
        products,
      });
      ...
      const errorMessage = err.response?.data?.message || "Something went wrong while contacting AI.";
  ...
  }, [question, loading, name, products]);
      ...
      >
        ...
        <div className="flex-1 p-4 overflow-y-auto bg-gradient-to-b from-white to-blue-50/50">
          {messages.length === 0 && (
            ...
            >
              <p className="text-lg font-medium">Hi {name}, how can I help you today?</p>
              <p className="text-sm">Ask about our shoes, sizes, or recommendations!</p>
            </motion.div>
          )}
                ...
                >
                  ...
                  >
                    <div className="flex items-center space-x-2 mb-1">
                      {msg.role === "user" && <User size={14} className="text-blue-500" />}
        ...
        <div className="sm:p-4 p-1 gap-1 bg-white border-t flex items-center sm:space-x-2  shadow-lg">
          ...
          <button
            ...
            className="p-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full shadow-md hover:scale-110 transition disabled:opacity-50 disabled:transform-none"
          ...
          <button
            onClick={clearChat}
            className="p-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full shadow-md hover:scale-110 "
            aria-label="Send message"
          >
           Clear
          </button>
